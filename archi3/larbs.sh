...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/lmartinez/voidrice.git" && repobranch="archi3"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/lmartinez/LARBS/master/archi3/progs.csv"
...
enableClickOnTap() { dialog --infobox "Enabling click on tap" 4 50
